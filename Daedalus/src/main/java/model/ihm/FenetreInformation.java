    ...
    private String textRegles(){
        ...
        "<html><br><br>"
            +"<p style='font-size:10px;'>"
                +"Le jeu <b>Daedalus</b> est un jeu qui consiste à parcourir des labyrinthes successifs jusqu'à gagner la partie."
                +" Le joueur doit choisir au départ un nombre de niveaux maximum (à finir pour gagner), puis s'il souhaite jouer avec ses propres labyrinthes prédéfinis ou les labyrinthes générés aléatoirement."
                +" Le premier labyrinthe est ensuite créé, et le joueur se retrouve positionné à l'entrée du labyrinthe, en compagnie de plusieurs types de monstres."
                +" On retrouve également dans les labyrinthes des cases à effets spéciaux (négatifs ou positifs pour le joueur), ainsi que des trésors pouvant contenir des potions, des armes ou des pièces d'armures."
                +"<br><br> Le but de ce jeu est de terminer le nombre de niveaux choisis au départ afin de gagner la partie. Pour cela, vous devez"
                ...
                +" les cases à effets négatifs. Il est conseillé de fouiller le plus de trésors possibles afin de récupérer des objets qui vous aideront beaucoup.."
                +"La partie est considérée comme perdue seulement lorsque le joueur est mort.<br><br>"
                +"Au niveau des armes, il existe plusieurs armes avec des nombres de points de dégat, des portées, mais aussi des zones d'attaques différentes. Il est possible de ramasser une arme sur dans le labyrinthe en échangeant avec celle que vous aviez avant.<br><br>"
                +"Pour les potions, lorsque vous en ramassez une, elle se place dans votre inventaire (s'il n'est pas plein), pour pouvoir ensuite la consommer quand vous le souhaitez.<br><br>"
                ...
                +"Ce système de rang permet d'augmenter les points de vie et points d'armures maximums, la place dans l'inventaire de potion, ainsi que les compétences disponibles."
