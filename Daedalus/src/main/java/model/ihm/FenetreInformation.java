    ...
    private String textRegles(){
        ...
        "<html><br><br>"
            +"<p style='font-size:10px;'>"
                ...
                +" On retrouve également dans les labyrinthes des cases à éffets spéciaux (négatif ou positif pour le joueur), ainsi que des trésors pouvant contenir des potions, des armes ou des pièces d'armures."
                ...
                +" les cases à éffets négatifs. Nous vous conseillons également de fouiller le maximum de trésors possible afin de récupérer des objets qui vous aideront beaucoup.."
                ...
                +"Pour ce qui est des potions, lorsque vous en ramassez une, elle se stoque dans votre inventaire (s'il n'est pas plein), pour pouvoir ensuite la consommer quand vous le souhaitez.<br><br>"
                ...
                +"Ce système de rang permets d'augmenter les points de vie et points d'armures maximums, la place dans l'inventaire de potion, ainsi que les compétances disponnibles."
                +"<br><br>Les compétances sont au nombre de quatres et sont obtenues automatiquement lorsque votre rang le permet. Voici un descriptif des compétances:"
            +"</p>"
            +"<ul>"
                +"<li>"
                    +"BERSERKER : Saccrifier 20 points de vie contre 50% de dégâts en plus pendant 10 secondes."
                +"</li>"
                +"<li>"
                    +"BOUCLIER MAGIQUE : Gagner 25 points d'armures temporaire (Deux niveaux de temps de recharge)."
                +"</li>"
                +"<li>"
                    +"DRAIN DE VIE : Vous ajoutez à vos points de vies chacuns des points de vie infligés à vos ennemis pendant 10 secondes"
                +"</li>"
                +"<li>"
    ...
    private String textCopyright(){
        ...
        "<html><br>"
            +"<p style='font-size:15px;'>"
                +"L'application du jeu <b>Daedalus</b> a été conçu dans le cadre d'un projet universitaire pour le module <b>Analyse et Conception De Logiciel</b> en M1 INFORMATIQUE (2022),"
                +" au sein de l'<b>Univeristé de Lorraine</b>. <br>Tous droits réservés à cette université ainsi qu'à ses créateurs.<br><br>"
            +"</p>"
            +"<p style='font-size:15px;'>"
            ...
            +"<ul>"
                ...
                +"</li>"
                +"<li>"
                    +"<span style='font-size:13px;'><i>M. Jérémy POIREL</i></span>"
                +"</li>"
                +"<li>"
                    +"<span style='font-size:13px;'><i>M. Victor NOEL</i></span>"
                +"</li>"
                +"<li>"
